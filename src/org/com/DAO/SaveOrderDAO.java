...
public interface SaveOrderDAO {
	...
	public int calc_ItemCost(String Name, int itm_Number, String order_ID) ;
	
	boolean my_orderSave(String username, String order_ID, String name, int value, int itm_cost);
