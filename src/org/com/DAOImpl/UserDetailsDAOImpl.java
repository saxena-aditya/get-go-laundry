...
public class UserDetailsDAOImpl implements UserDetailsDAO {
  ...
  public String getUserAddress(String username) {
    ...
    String add1 = getJdbcTemplate()
      .queryForObject(sql.SEE_ADD1, inputs1, String.class);
    String add2 = getJdbcTemplate()
      .queryForObject(sql.SEE_ADD2, inputs2, String.class);
