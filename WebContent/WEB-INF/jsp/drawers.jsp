...
<div class="container top-desk navbar-fixed-top">
       ...
       <li class="dropdown drpdwn">
         <a class="dropdown-toggle" data-toggle="dropdown" href="#">${username}<span class="caret"></span></a>
          <ul class="dropdown-menu">
            ...
            <li><a href="prices"><i class="fa fa-inr" aria-hidden="true"></i>&nbsp;&nbsp;Prices</a></li>
  ...
  <div class="container side-bar">
   <ul class="nav nav-pills nav-stacked">
     ...
     <li class = "prices"><a href="prices"  id="list-itm"><i class="fa fa-inr" aria-hidden="true"></i>&nbsp;&nbsp;Prices</a></li>
     <li id="order-form"><a data-toggle = "modal" data-target="#banner-text" title="" id="btnClick" href="#"><span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;&nbsp;Order Now</a></li>
