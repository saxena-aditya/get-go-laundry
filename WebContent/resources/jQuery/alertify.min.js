  ...
  var n = { ENTER: 13, ESC: 27, F1: 112, F12: 123, LEFT: 37, RIGHT: 39 },
    ...
    t = (function () {
      function m(a) {
        if (!a.__internal) {
          delete a.__init,
            ...
            null === za && document.body.setAttribute("tabindex", "0");
          var c;
          ...
          (l.root = document.createElement("div")),
            (l.root.className = Ca.base + " " + Ca.hidden + " "),
            (l.root.innerHTML = Ba.dimmer + Ba.modal),
            (l.dimmer = l.root.firstChild),
            (l.modal = l.root.lastChild),
            (l.modal.innerHTML = Ba.dialog),
            ...
            (l.body.innerHTML = Ba.content),
            (l.content = l.body.firstChild),
            (l.footer = l.body.nextSibling),
            (l.footer.innerHTML = Ba.buttons.auxiliary + Ba.buttons.primary),
            ...
            (l.buttons.primary.innerHTML = Ba.button),
      ...
      function u() {
        ...
        0 === a && document.body.className.indexOf(Ca.noOverflow) >= 0
          ? (c(document.body, Ca.noOverflow), w(!1))
          : a > 0 &&
            document.body.className.indexOf(Ca.noOverflow) < 0 &&
            (w(!0), b(document.body, Ca.noOverflow));
      }
      function w(d) {
        v.defaults.preventBodyShift &&
          ...
          (d
            ? ((Ea = xa),
              (Da = a.getComputedStyle(document.body).top),
              b(document.body, Ca.fixed),
              (document.body.style.top = -xa + "px"))
            : ((xa = Ea),
              (document.body.style.top = Da),
              c(document.body, Ca.fixed),
              t()));
      }
      function x(a, d, e) {
        "string" == typeof e && c(a.elements.root, Ca.prefix + e),
          b(a.elements.root, Ca.prefix + d),
          (za = a.elements.root.offsetWidth);
      }
      function y(a) {
        a.get("modal")
          ? (c(a.elements.root, Ca.modeless), a.isOpen() && (pa(a), N(a), u()))
          : (b(a.elements.root, Ca.modeless), a.isOpen() && (oa(a), N(a), u()));
      }
      function z(a) {
        a.get("basic")
          ? b(a.elements.root, Ca.basic)
          : c(a.elements.root, Ca.basic);
      }
      function A(a) {
        a.get("frameless")
          ? b(a.elements.root, Ca.frameless)
          : c(a.elements.root, Ca.frameless);
      }
      function B(a, b) {
      ...
      function C(a, d, e, f) {
        switch (d) {
          ...
          case "padding":
            f
              ? c(a.elements.root, Ca.noPadding)
              : a.elements.root.className.indexOf(Ca.noPadding) < 0 &&
                b(a.elements.root, Ca.noPadding);
            break;
          case "overflow":
            f
              ? c(a.elements.root, Ca.noOverflow)
              : a.elements.root.className.indexOf(Ca.noOverflow) < 0 &&
                b(a.elements.root, Ca.noOverflow);
            break;
          case "transition":
            x(a, f, e);
        }
      ...
      function I(a) {
        l("onmaximize", a),
          b(a.elements.root, Ca.maximized),
          a.isOpen() && u(),
          l("onmaximized", a);
      }
      function J(a) {
        l("onrestore", a),
          c(a.elements.root, Ca.maximized),
          a.isOpen() && u(),
          l("onrestored", a);
      }
      function K(a) {
        a.get("pinnable")
          ? b(a.elements.root, Ca.pinnable)
          : c(a.elements.root, Ca.pinnable);
      }
      function L(a) {
        var b = f();
      ...
      function O(a) {
        a.get("pinned")
          ? (c(a.elements.root, Ca.unpinned), a.isOpen() && M(a))
          : (b(a.elements.root, Ca.unpinned),
            a.isOpen() && !a.isModal() && L(a));
      }
      function P(a) {
        a.get("maximizable")
          ? b(a.elements.root, Ca.maximizable)
          : c(a.elements.root, Ca.maximizable);
      }
      function Q(a) {
        a.get("closable")
          ? (b(a.elements.root, Ca.closable), ua(a))
          : (c(a.elements.root, Ca.closable), va(a));
      }
      function R(a, b) {
        var c = a.srcElement || a.target;
        return (
      ...
      function Y(a, b) {
        clearTimeout(b.__internal.timerIn),
          ...
          c(b.elements.root, Ca.animationIn);
      }
      function Z(a, b) {
      ...
      function _(a, b) {
        var c = a[Ka] - Ia,
          d = a[La] - Ja;
        Na && (d -= document.body.scrollTop),
          (b.style.left = Math.min(Ma.maxLeft, Math.max(Ma.minLeft, c)) + "px"),
          Na
            ? (b.style.top = Math.min(Ma.maxTop, Math.max(Ma.minTop, d)) + "px")
            : (b.style.top = Math.max(Ma.minTop, d) + "px");
      }
      function aa(a, c) {
        if (null === Pa && !c.isMaximized() && c.get("movable")) {
          ...
          if (
            ...
            if (
              ...
              (Ja = d[La] - f),
              c.isModal()
                ? (Ja += c.elements.modal.scrollTop)
                : c.isPinned() && (Ja -= document.body.scrollTop),
              c.get("moveBounded"))
            ) {
              var h = g,
                i = -e,
            ...
            return (
              l("onmove", c),
              (Na = !c.isModal() && c.isPinned()),
              (Ha = c),
              Oa(d, g),
              b(document.body, Ca.noSelection),
              !1
            );
          }
        }
      ...
      function ca() {
        if (Ha) {
          var a = Ha;
          (Ha = Ma = null),
            c(document.body, Ca.noSelection),
            c(a.elements.dialog, Ca.capture),
            l("onmoved", a);
        }
      }
      function da(a) {
      ...
      function ea(a) {
        a.get("movable")
          ? (b(a.elements.root, Ca.movable), a.isOpen() && qa(a))
          : (da(a), c(a.elements.root, Ca.movable), a.isOpen() && ra(a));
      }
      function fa(a, b, c) {
        var e = b,
          f = 0,
        ...
        if (
          (j &&
            ...
            isNaN(Qa) || (f = document.body.offsetWidth - f - b.offsetWidth)),
          (b.style.height = i - g + Ta + "px"),
          (b.style.width = h - f + Ta + "px"),
          !isNaN(Qa))
        ) {
          var k = 0.5 * Math.abs(b.offsetWidth - Ra);
          j && (k *= -1),
            b.offsetWidth > Ra
              ? (b.style.left = Qa + k + "px")
              : b.offsetWidth >= Sa && (b.style.left = Qa - k + "px");
        }
      }
      function ga(a, c) {
        if (!c.isMaximized()) {
          ...
          if (
            ...
            l("onresize", c),
              (Pa = c),
              (Ta = c.elements.resizeHandle.offsetHeight / 2);
            var e = c.elements.dialog;
            return (
              b(e, Ca.capture),
              (Qa = parseInt(e.style.left, 10)),
              (e.style.height = e.offsetHeight + "px"),
              (e.style.minHeight =
                c.elements.header.offsetHeight +
                c.elements.footer.offsetHeight +
                "px"),
              (e.style.width = (Ra = e.offsetWidth) + "px"),
              "none" !== e.style.maxWidth &&
                (e.style.minWidth = (Sa = e.offsetWidth) + "px"),
      ...
      function ha(a) {
        if (Pa) {
          ...
          "touchmove" === a.type
            ...
            : 0 === a.button && (b = a),
            b &&
              fa(b, Pa.elements.dialog, !Pa.get("modal") && !Pa.get("pinned"));
        }
      }
      function ia() {
        if (Pa) {
      ...
      function ka(a) {
        a.get("resizable")
          ? (b(a.elements.root, Ca.resizable), a.isOpen() && sa(a))
          : (ja(a), c(a.elements.root, Ca.resizable), a.isOpen() && ta(a));
      }
      function la() {
        ...
        resizeTo: function (a, b) {
          ...
          if (!isNaN(c) && !isNaN(d) && this.get("resizable") === !0) {
            ...
            "none" !== f.style.maxWidth &&
              (f.style.minWidth = (Sa = f.offsetWidth) + "px"),
        ...
        show: function (a, d) {
          if ((m(this), this.__internal.isOpen)) {
            ...
            if (
              ...
              N(this),
              c(this.elements.root, Ca.animationOut),
              b(this.elements.root, Ca.animationIn),
            ...
            (za = this.elements.root.offsetWidth),
              c(this.elements.root, Ca.hidden),
        ...
        close: function () {
          return (
            this.__internal.isOpen &&
              (na(this),
              c(this.elements.root, Ca.animationIn),
              b(this.elements.root, Ca.animationOut),
              clearTimeout(this.__internal.timerOut),
              (this.__internal.timerOut = setTimeout(
                this.__internal.transitionOutHandler,
                s.supported ? 1e3 : 100,
              )),
              b(this.elements.root, Ca.hidden),
          ...
          delay: function (a) {
            if (
              ...
              (this.__internal.delay =
                "undefined" == typeof a || isNaN(+a) ? u.__internal.delay : +a),
